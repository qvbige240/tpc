...
TPC_CFLAGS  = -g -O0 -DUSE_ZLOG -I$(INC_PJ) -I$(INC) -I$(INC_TPC) -DTPC_CONFIG_ANDROID=0 -DSIP_SERVER_INTERNAL $(GOLBAL_CFLAGS) -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1
